...
[
    wxID_WXDIALOG1,
    wxID_WXDIALOG1BUTTON1,
    wxID_WXDIALOG1BUTTON2,
    wxID_WXDIALOG1BUTTON3,
    wxID_WXDIALOG1STATICBOX1,
    wxID_WXDIALOG1STATICBOX2,
    wxID_WXDIALOG1STATICBOX3,
    wxID_WXDIALOG1STATICTEXT1,
    wxID_WXDIALOG1STATICTEXT10,
    wxID_WXDIALOG1STATICTEXT11,
    wxID_WXDIALOG1STATICTEXT12,
    wxID_WXDIALOG1STATICTEXT13,
    wxID_WXDIALOG1STATICTEXT14,
    wxID_WXDIALOG1STATICTEXT15,
    wxID_WXDIALOG1STATICTEXT16,
    wxID_WXDIALOG1STATICTEXT17,
    wxID_WXDIALOG1STATICTEXT18,
    wxID_WXDIALOG1STATICTEXT2,
    wxID_WXDIALOG1STATICTEXT3,
    wxID_WXDIALOG1STATICTEXT4,
    wxID_WXDIALOG1STATICTEXT5,
    wxID_WXDIALOG1STATICTEXT6,
    wxID_WXDIALOG1STATICTEXT7,
    wxID_WXDIALOG1STATICTEXT8,
    wxID_WXDIALOG1STATICTEXT9,
    wxID_WXDIALOG1TXTBITSPERPIXEL,
    wxID_WXDIALOG1TXTBITSPERSAMPLE,
    wxID_WXDIALOG1TXTBOTTOM,
    wxID_WXDIALOG1TXTCOMPRESSION,
    wxID_WXDIALOG1TXTDOCUMENTNUMBER,
    wxID_WXDIALOG1TXTFRAMENUMBER,
    wxID_WXDIALOG1TXTIMAGELENGTH,
    wxID_WXDIALOG1TXTIMAGEWIDTH,
    wxID_WXDIALOG1TXTLEFT,
    wxID_WXDIALOG1TXTPAGENUMBER,
    wxID_WXDIALOG1TXTPIXELTYPE,
    wxID_WXDIALOG1TXTPLANAR,
    wxID_WXDIALOG1TXTRIGHT,
    wxID_WXDIALOG1TXTSAMPLESPERPIXEL,
    wxID_WXDIALOG1TXTTOP,
    wxID_WXDIALOG1TXTXRESOLUTION,
    wxID_WXDIALOG1TXTYRESOLUTION,
...
class wxDialog1(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.staticText1.SetFont(
            wx.Font(12, wx.SWISS, wx.NORMAL, wx.NORMAL, False, "MS Sans Serif")
        )
        ...
        self.button1.Bind(
            wx.EVT_BUTTON, self.on_transfer_natively_click, id=wxID_WXDIALOG1BUTTON1
        )
        ...
        self.txtXResolution = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTXRESOLUTION,
            name="txtXResolution",
            parent=self,
            pos=wx.Point(160, 64),
            size=wx.Size(100, 21),
        ...
        self.txtYResolution = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTYRESOLUTION,
            name="txtYResolution",
            parent=self,
            pos=wx.Point(160, 88),
            size=wx.Size(100, 21),
        ...
        self.txtImageWidth = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTIMAGEWIDTH,
            name="txtImageWidth",
            parent=self,
        ...
        self.txtImageLength = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTIMAGELENGTH,
            name="txtImageLength",
            parent=self,
        ...
        self.txtBitsPerSample = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTBITSPERSAMPLE,
        ...
        self.txtBitsPerPixel = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTBITSPERPIXEL,
        ...
        self.txtPlanar = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTPLANAR,
            name="txtPlanar",
            parent=self,
        ...
        self.txtPixelType = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTPIXELTYPE,
            name="txtPixelType",
            parent=self,
        ...
        self.txtCompression = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTCOMPRESSION,
            name="txtCompression",
            parent=self,
        ...
        self.txtPageNumber = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTPAGENUMBER,
            name="txtPageNumber",
            parent=self,
            pos=wx.Point(408, 96),
            size=wx.Size(100, 21),
        ...
        self.txtFrameNumber = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTFRAMENUMBER,
            name="txtFrameNumber",
            parent=self,
        ...
        self.staticText18 = wx.StaticText(
            id=wxID_WXDIALOG1STATICTEXT18,
            label="Frame Number:",
            name="staticText18",
            parent=self,
        ...
        self.txtLeft = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTLEFT,
            name="txtLeft",
            parent=self,
        ...
        self.txtTop = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTTOP,
            name="txtTop",
            parent=self,
        ...
        self.txtRight = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTRIGHT,
            name="txtRight",
            parent=self,
        ...
        self.staticText16 = wx.StaticText(
            id=wxID_WXDIALOG1STATICTEXT16,
            label="Right",
            name="staticText16",
            parent=self,
        ...
        self.txtBottom = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTBOTTOM,
            name="txtBottom",
            parent=self,
        ...
        self.staticText17 = wx.StaticText(
            id=wxID_WXDIALOG1STATICTEXT17,
            label="Bottom:",
            name="staticText17",
            parent=self,
        ...
        self.staticBox3 = wx.StaticBox(
            id=wxID_WXDIALOG1STATICBOX3,
    ...
    def OnButton2Button(self, event):
        ...
        if GetXferFileNameWorks:
            ...
            try:
                ...
                if rv:
                    self.Control.Log(
                        "self.SS.SetXferFileName('%s', %d)" % (dlg.Name, dlg.imgType)
                    )
                    if dlg.Name:
