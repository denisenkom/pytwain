...
[
    wxID_WXDIALOG1,
    wxID_WXDIALOG1BTNONEVALCANCEL,
    wxID_WXDIALOG1BTNONEVALRESET,
    wxID_WXDIALOG1BTNONEVALUPDATE,
    wxID_WXDIALOG1NOTEBOOK1,
    wxID_WXDIALOG1PANEL1,
    wxID_WXDIALOG1PANEL2,
    wxID_WXDIALOG1PANEL3,
    wxID_WXDIALOG1PANEL4,
    wxID_WXDIALOG1RBCAPABILITYTYPE,
    wxID_WXDIALOG1STATICTEXT1,
    wxID_WXDIALOG1TXTVALUE,
...
class wxDialog1(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(357, 145),
            size=wx.Size(429, 369),
        ...
        self.notebook1 = wx.Notebook(
            id=wxID_WXDIALOG1NOTEBOOK1,
            name="notebook1",
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(421, 342),
            style=0,
        )

        self.panel1 = wx.Panel(
            id=wxID_WXDIALOG1PANEL1,
            name="panel1",
            parent=self.notebook1,
            pos=wx.Point(0, 0),
            size=wx.Size(413, 316),
            style=wx.TAB_TRAVERSAL,
        )

        self.panel2 = wx.Panel(
            id=wxID_WXDIALOG1PANEL2,
            name="panel2",
            parent=self.notebook1,
            pos=wx.Point(0, 0),
            size=wx.Size(413, 316),
        ...
        self.txtValue = wx.TextCtrl(
            id=wxID_WXDIALOG1TXTVALUE,
            name="txtValue",
            parent=self.panel1,
            pos=wx.Point(152, 32),
            size=wx.Size(100, 21),
        ...
        self.rbCapabilityType = wx.RadioBox(
            choices=[
                "TWTY_UINT32",
                "TWTY_STR64",
                "TWTY_UINT16",
            ...
            id=wxID_WXDIALOG1RBCAPABILITYTYPE,
            label="Type of the Value",
            majorDimension=3,
            name="rbCapabilityType",
            parent=self.panel1,
            point=wx.Point(40, 96),
            size=wx.Size(350, 128),
            style=wx.RA_SPECIFY_COLS,
            validator=wx.DefaultValidator,
        )

        self.btnOneValUpdate = wx.Button(
            id=wxID_WXDIALOG1BTNONEVALUPDATE,
            label="Update Value",
            name="btnOneValUpdate",
            parent=self.panel1,
            pos=wx.Point(64, 272),
            size=wx.Size(75, 23),
            style=0,
        )
        self.btnOneValUpdate.Bind(
            wx.EVT_BUTTON,
            self.OnBtnonevalupdateButton,
            id=wxID_WXDIALOG1BTNONEVALUPDATE,
        )

        self.btnOneValReset = wx.Button(
            id=wxID_WXDIALOG1BTNONEVALRESET,
            label="Reset Value",
            name="btnOneValReset",
            parent=self.panel1,
            pos=wx.Point(176, 272),
            size=wx.Size(75, 23),
            style=0,
        )
        self.btnOneValReset.Bind(
            wx.EVT_BUTTON, self.OnBtnonevalresetButton, id=wxID_WXDIALOG1BTNONEVALRESET
        )

        self.btnOneValCancel = wx.Button(
            id=wxID_WXDIALOG1BTNONEVALCANCEL,
            label="Close",
            name="btnOneValCancel",
            parent=self.panel1,
            pos=wx.Point(288, 272),
            size=wx.Size(75, 23),
            style=0,
        )
        self.btnOneValCancel.Bind(
            wx.EVT_BUTTON,
            self.OnBtnonevalcancelButton,
            id=wxID_WXDIALOG1BTNONEVALCANCEL,
        )
    ...
    def OnBtnonevalupdateButton(self, event):
        ...
        try:
            self.Control.Log(
                "self.SS.SetCapability(twain.%s, twain.%s, %s)"
