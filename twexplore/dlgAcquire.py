...
[
    ...
    wxID_WXDIALOG1CBMODAL,
    wxID_WXDIALOG1CBSHOWUI,
...
class wxDialog1(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(398, 267),
            size=wx.Size(379, 209),
            style=wx.DEFAULT_DIALOG_STYLE,
            title="Acquire Data from TWAIN Source",
        )
        self._init_utils()
        ...
        self.button2 = wx.Button(
            ...
            name="button2",
            parent=self,
            pos=wx.Point(144, 120),
            size=wx.Size(75, 23),
            style=0,
        )
        self.button2.Bind(wx.EVT_BUTTON, self.OnButton2Button, id=wxID_WXDIALOG1BUTTON2)

        self.cbShowUI = wx.CheckBox(
            id=wxID_WXDIALOG1CBSHOWUI,
            label="Show Source User Interface",
            name="cbShowUI",
            parent=self,
            pos=wx.Point(112, 40),
            size=wx.Size(160, 13),
        ...
        self.cbModal = wx.CheckBox(
            id=wxID_WXDIALOG1CBMODAL,
            label="Source User Interface is Modal",
            name="cbModal",
            parent=self,
            pos=wx.Point(112, 80),
            size=wx.Size(176, 13),
    ...
    def OnButton1Button(self, event):
        try:
            ...
            self.Control.Log(
                "self.SS.RequestAcquire(%d, %d)"
                % (self.cbShowUI.GetValue(), self.cbModal.GetValue())
            )
            rv = self.SS.RequestAcquire(
                self.cbShowUI.GetValue(), self.cbModal.GetValue()
            )
            self.EndModal(1)
    ...
    def OnButton3Button(self, event):
        ...
        try:
            ...
            if rv:
                self.Control.Log(
                    "self.SS.SetImageLayout((%f, %f, %f, %f), %d, %d, %d)"
                    % (
                        dlg.Left,
                        dlg.Top,
                        dlg.Right,
