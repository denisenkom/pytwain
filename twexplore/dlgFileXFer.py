...
[
    ...
    wxID_WXDIALOG1CHOICEFILEFORMAT,
    wxID_WXDIALOG1STATICTEXT1,
    wxID_WXDIALOG1STATICTEXT2,
    wxID_WXDIALOG1TXTFILENAME,
...
class wxDialog1(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(479, 193),
            size=wx.Size(442, 222),
            style=wx.DEFAULT_DIALOG_STYLE,
            title="Transfer By File",
        )
        self._init_utils()
        ...
        self.choiceFileFormat = wx.Choice(
            choices=[],
            id=wxID_WXDIALOG1CHOICEFILEFORMAT,
            name="choiceFileFormat",
            parent=self,
            pos=wx.Point(144, 64),
            size=wx.Size(192, 21),
            style=0,
